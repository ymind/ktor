...
class ParametersSerializationTest {
    ...
    fun testSimpleSerialization() {
        ...
        assertEquals("2.0", encoded["floatValue"])
    ...
    fun testCollectionsSerialization() {
        ...
        val collectionLocations = CollectionLocations(listOf(3.1, 5.1), primitivesLocation, listOf(3, 5))
        ...
        assertEquals(listOf("3", "5"), encoded.getAll("someMoreValues"))
        assertEquals("1", encoded["intValue"])
        assertEquals("2.0", encoded["floatValue"])
        assertEquals("a", encoded["charValue"])
